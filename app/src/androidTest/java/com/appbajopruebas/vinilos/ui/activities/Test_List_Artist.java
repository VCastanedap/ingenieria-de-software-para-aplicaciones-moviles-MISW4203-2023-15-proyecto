...
import com.appbajopruebas.vinilos.ListArtistasActivity;
...
public class Test_List_Artist {

    @Before
    public void launchActivity() {
        Intent intent = new Intent(ApplicationProvider.getApplicationContext(), ListArtistasActivity.class);
